...
import avatar from './asset/img/matthew-hamilton-tNCH0sKSZbA-unsplash.jpg';
  ...
  <div className='home-background'>
     ...
     <div className='row align-items-center'>
      <div className='col-lg-8 col-md-12 col-sm-12 col-12'>
       <div className='alterra'>
        <a href='index.html'>
         <img className='logo-atas' src={logo} alt='Logo ALTA' />
        </a>
       </div>
      </div>
   ...
   <div className='container h-100'>
    <div className='row align-items-center isi-home'>
     <div className='col-lg-4 col-md-12 col-sm-12 col-12'>
      <img id='foto-profil' src={avatar} alt='Foto Profil' />
     </div>
     <div className='col-lg-8 col-md-12 col-sm-12 col-12'>
